...
export const metadata = {
  ...
  description:
    "Information about how AuctionMyPlate.co.uk uses cookies and similar technologies.",
};
    ...
    <main className="min-h-screen bg-[#FFFBEA] py-10 px-4">
      <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-md border border-yellow-100 p-8">
        ...
        <p className="text-sm text-gray-700 mb-6">
          This Cookie Policy explains how AuctionMyPlate.co.uk (“we”, “us”,
        ...
        <div className="space-y-6 text-sm text-gray-800 leading-relaxed">
          ...
          <section>
            ...
            <p>
              ...
              preferences so you don’t have to re-enter them every time you
              return.
            </p>
            <p className="mt-2">
              We also use similar technologies such as local storage to keep you
              logged in and maintain session-related data.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc ml-5 mt-2 space-y-1">
              <li>
                ...
                function, such as keeping you logged in and securing forms.
              </li>
              <li>
          ...
          <section>
            ...
            <ul className="list-disc ml-5 mt-2 space-y-1">
              <li>
                Cookies that store your login session so you don’t have to sign
                in every page view.
              </li>
              <li>Cookies that remember your chosen preferences on the site.</li>
              <li>
          ...
          <section>
            ...
            <p className="mt-2">
              ...
              stay logged in or place bids correctly if essential cookies are
              disabled.
            </p>
          </section>
